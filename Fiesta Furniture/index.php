...
<!-- site metas -->
<title>Fiesta Furniture</title>
<meta name="keywords" content="furniture,fiesta,designed furnitures">
<meta name="description" content="This is Fiesta Furniture official website">
<meta name="author" content="@mrsoftwarengineer">	
<!-- bootstrap css -->
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav mr-auto">
                               <li class="nav-item active">
                                <a class="nav-link active" href="index.php">Home<span class="sr-only">(current)</span></a> </li>
                               <li class="nav-item">
                                <a class="nav-link" href="about.php">About</a></li>
                               <li class="nav-item">
                                <a class="nav-link" href="company.php">Company</a></li>
                               <li class="#" href="#">
      	                        <a class="nav-link" href="furnitures.php">Furnitures</a></li>
                     ...
                     <div class="shoping_bag">
						 <form action="urunler.php"  method="post">
							<table>
									<tr>
										<td width="400px">
											<input width="100%" type="text" name="arananUrun" placeholder="What are you looking for"></input>
										</td> 
										<td>
											&nbsp;&nbsp;&nbsp;
										</td> 
										<td width="auto">
											<button  id="search-button" class="btn btn-warning" type="submit">Find Best Furniture</button>
										</td>
									</tr>
								</table>
						</form>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <div class="row">
				    ...
				    <div class="col-sm-5">
				    	<h1 class="furniture_text">2022</h1>
