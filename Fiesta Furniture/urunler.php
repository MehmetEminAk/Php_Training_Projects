...
<body>
    <?php   
        ...
        if(isset($_GET["urun"])){
            $sorgulanan=$_GET["urun"];
                    $con=mysqli_connect("localhost","root","","akticaret");
                    
                    $results1=mysqli_query($con,"SELECT * FROM products WHERE PRODUCT_NAME=\"$sorgulanan\"");
                    
                    
                    while($satir=mysqli_fetch_array($results1))
                    {
                        ...
                        <div class="container-fluid">
                          <div class="row">
                            ...
                            echo "<br><br> <center>".$satir['PRODUCT_NAME'] ." ile ilgili sonuçlar </center>

                            <table>
                                    <tr>
                                        <td>
                                            <img class='teshirResimler'  src=".$satir["PRODUCT_IMG_PATH"]." alt='Alternatif'>
                                        </td>
                                        <td>
                                            <p>".$satir['PRODUCT_NAME']."<br>". $satir["PRODUCT_PRICE"]." ". $satir["CURRENCY_UNIT"]. "</p>
                                        </td>
                                    </tr>
                                    <tr>
                    </table>";
